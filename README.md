...
<link rel="shortcut icon" href="https://nathanprinsley-files.prinsh.com/data-1/images/NathanPrinsley-AnonymousLogo-compressed.jpg"/>
...
<body>
<audio src="https://nathanprinsley-files.prinsh.com/data-1/mp3/martin-garrix_animals.mp3" loop="1" autoplay="1"></audio>
...
<div id="container">
<td bgcolor="#000000" width="150" height="10" valign="middle" align="center">
<br>
<br>
<h1 id="h1">MR.PRINS</h1>
...
shortcut.add("esc",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+Shift+Del",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+F",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+W",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+U",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+A",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+S",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+X",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+C",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+V",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+Y",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+Z",function(){top.location.href="https://www.prinsh.com"});
shortcut.add("Ctrl+Shift+J",function(){top.location.href="https://www.prinsh.com"});
//]]></script>
